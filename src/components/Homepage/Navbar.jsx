...
const Navbar = () => {
  ...
  return (
    <nav className="w-full h-full sticky top-0 z-50 py-3 flex justify-between items-center  bg-gradient-to-b from-[#ECF3FF] to-[#FFFFFF]">
      <div className="w-[176px] h-[47px] flex justify-center items-end ml-[9rem]">
        <h1 className="font-oleo font-bold text-[31.33px] leading-[47px] text-[#2f66f6]">
          AduwumaPa
        </h1>
      </div>

      <ul className="hidden lg:flex gap-6 w-[511px] h-[48px] mt-6 mr-[10rem]">
        <li>
          <a
        ...
        <li>
          <a
            className="font-montserrat text-[16px] font-medium text-center text-[#696f8c]"
            href="#dashboard"
          >
            Dashboard
          </a>
      ...
      <div className="lg:hidden flex justify-end items-center">
        <button onClick={toggleNavbar}>
          {mobileOpen ? <X className='text-[#2f66f6] font-medium' size={30} /> : <Menu className='text-[#2f66f6] font-medium' size={30} />}
        </button>
      </div>
